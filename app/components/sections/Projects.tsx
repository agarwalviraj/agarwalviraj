...
const Projects = () => {
  ...
  const allProjects: projectType[] = [
    {
      image: "/assets/projects/Sandesh.png",
      name: "Sandesh",
      description: [
    ...
    {
      image: "/assets/projects/Mozofest.png",
      name: "Mozofest",
      description: [
    ...
    {
      image: "/assets/projects/EventsPortal.png",
    ...
    {
      image: "/assets/projects/SupportPanel.png",
      name: "Supprt Panel",
      description: [
    ...
    {
      image: "/assets/projects/WebsiteBuilder.png",
      ...
      {!openProject ? (
        ...
        <div className="projects main-section single-project">
          ...
          <div
            className="image"
            style={{
              backgroundImage: `linear-gradient(to right,#0a192f, #36393fcc 66%,#508b917f) ,url(${openProject.image})`,
            }}
          ></div>
        </div>
      )}
